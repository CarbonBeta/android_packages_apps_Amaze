...
package com.amaze.carbonfilemanager.fragments;
...
import com.amaze.carbonfilemanager.activities.BaseActivity;
import com.amaze.carbonfilemanager.activities.MainActivity;
import com.amaze.carbonfilemanager.adapters.RecyclerAdapter;
import com.amaze.carbonfilemanager.database.CloudHandler;
import com.amaze.carbonfilemanager.database.CryptHandler;
import com.amaze.carbonfilemanager.database.EncryptedEntry;
...
import com.amaze.carbonfilemanager.filesystem.MediaStoreHack;
import com.amaze.carbonfilemanager.filesystem.RootHelper;
import com.amaze.carbonfilemanager.fragments.preference_fragments.Preffrag;
import com.amaze.carbonfilemanager.services.EncryptService;
import com.amaze.carbonfilemanager.services.asynctasks.LoadList;
import com.amaze.carbonfilemanager.ui.LayoutElement;
import com.amaze.carbonfilemanager.ui.dialogs.GeneralDialogCreation;
import com.amaze.carbonfilemanager.ui.icons.IconHolder;
import com.amaze.carbonfilemanager.ui.icons.IconUtils;
import com.amaze.carbonfilemanager.ui.icons.Icons;
import com.amaze.carbonfilemanager.ui.icons.MimeTypes;
import com.amaze.carbonfilemanager.ui.views.DividerItemDecoration;
import com.amaze.carbonfilemanager.ui.views.FastScroller;
...
import com.amaze.carbonfilemanager.utils.SmbStreamer.Streamer;
import com.amaze.carbonfilemanager.utils.Utils;
import com.amaze.carbonfilemanager.utils.cloud.CloudUtil;
import com.amaze.carbonfilemanager.utils.color.ColorUsage;
import com.amaze.carbonfilemanager.utils.files.CryptUtil;
import com.amaze.carbonfilemanager.utils.files.FileListSorter;
...
import static com.amaze.carbonfilemanager.activities.MainActivity.dataUtils;
            ...
            switch (item.getItemId()) {
                ...
                case R.id.about:
                    ...
                    GeneralDialogCreation.showPropertiesDialogWithPermissions((x).generateBaseFile(), x.getPermissions(),
                            (BaseActivity) getActivity(), BaseActivity.rootMode,
                ...
                */
                ...
                case R.id.compress:
                    ...
                    return true;
                case R.id.openwith:
                    Futils.openunknown(new File(getLayoutElement(plist.get(0)).getDesc()), getActivity(), true);
                    return true;
