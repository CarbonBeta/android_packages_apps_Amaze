package com.amaze.carbonfilemanager.ui.dialogs;
...
import com.amaze.carbonfilemanager.adapters.HiddenAdapter;
import com.amaze.carbonfilemanager.adapters.RecyclerAdapter;
import com.amaze.carbonfilemanager.exceptions.RootNotPermittedException;
...
import com.amaze.carbonfilemanager.services.asynctasks.CountItemsOrAndSize;
import com.amaze.carbonfilemanager.services.asynctasks.GenerateHashes;
import com.amaze.carbonfilemanager.services.asynctasks.LoadFolderSpaceData;
import com.amaze.carbonfilemanager.ui.LayoutElement;
import com.amaze.carbonfilemanager.utils.DataUtils;
import com.amaze.carbonfilemanager.utils.FingerprintHandler;
...
import static com.amaze.carbonfilemanager.utils.files.Futils.toHFileArray;
...
public class GeneralDialogCreation {
    ...
    public static void showSortDialog(final MainFragment m, AppTheme appTheme) {
        int accentColor = m.MAIN_ACTIVITY.getColorPreference().getColor(ColorUsage.ACCENT);
