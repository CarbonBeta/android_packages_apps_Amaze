...
import com.amaze.carbonfilemanager.utils.EditTextColorStateUtil;
import com.amaze.carbonfilemanager.utils.OpenMode;
import com.amaze.carbonfilemanager.utils.SimpleTextWatcher;
...
public class SmbConnectDialog extends DialogFragment {
    ...
    public interface SmbConnectionListener{
         ...
         *             See {@link com.amaze.carbonfilemanager.utils.HistoryManager#removePath(String, String, String)}
         */
